...
print('\n')
print('Welcome to Usayds Inventory Management, Here is your Inventory:')
print('\n')
...
saveInventory()
print('\n')
print('Thank you for using Usayds Inventory Management, Your last entries')
print('have been auto saved!')
